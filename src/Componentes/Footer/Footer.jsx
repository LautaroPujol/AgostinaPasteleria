        ...
        <footer className="Footerflex">
            ...
            <div className='Imagenes'>
                <Link to="https://www.instagram.com/agostina.pasteleria/" target="_blank" rel="noopener">
                    <img className="imagen-footer " src="/AgostinaPasteleria/imagenes/logotipoinstagram.png"
                        alt="instagram"></img>
                </Link>
                <Link
                    to="http://qr.afip.gob.ar/?qr=8s6BAcXV2i7PbAFO10hLyw,," target="_F960AFIPInfo" rel="noopener">
                    <img className="imagen-footer" src="/AgostinaPasteleria/imagenes/datafiscal.jpg " alt="Data Fiscal"></img>
                </Link>
